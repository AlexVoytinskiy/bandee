...
class Metro extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, name, id_city', 'safe', 'on' => 'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'profiles' => array(self::HAS_MANY, 'Profile', 'id_metro'),
		);
	}
	...
	public static function takeAllById($id)
	{
		return CHtml::listData(self::model()->findAll('id_city = :Id_city', array(':Id_city' => $id)), 'id', 'name');
	}
} 