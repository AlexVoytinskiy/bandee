...
class Mailer
{
	...
	var $to; // (string) Кому
	var $charset; // (string) Кодировка (по умолчанию utf-8)
	...
	//	Перекодируем заголовки для русского текста в UTF -8
	public function codeMailHeader($text)
	{
	...
	function Send()
	{
		...
		$this->sHeaders = "From: noreply@bandee.ru\r\n";
